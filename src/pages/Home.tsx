...
import photoProfil from "../assets/images/profile.jpg"
import  imgNexusops  from '../assets/images/nexus.png';
import imgShosea from '../assets/images/shosea.png';
import imgKollectiv from '../assets/images/kolllectiv.png';
import imgLuxurybox from '../assets/images/a.sluxury.png';
import imgLumencrm from '../assets/images/lumencrm.png';
import imgVineta from '../assets/images/vineta.png';
import imgDrepanocare from '../assets/images/drepanocare.png';
      ...
      <section className="max-w-7xl mx-auto px-6 pt-12 md:pt-20 pb-16 flex flex-col justify-between min-h-[calc(100vh-80px)]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center my-auto">
          ...
          <div className="lg:col-span-4 flex justify-center lg:justify-end mt-6 lg:mt-0">
            <div className="w-64 h-80 sm:w-72 sm:h-96 rounded-3xl border border-zinc-800/80 bg-gradient-to-br from-zinc-950/60 to-zinc-950/20 overflow-hidden backdrop-blur-sm relative group transition-all duration-300 hover:border-orange-500/30 shadow-2xl">
              <div className="absolute inset-0 bg-orange-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"></div>
              <img 
                src={photoProfil} 
                alt="Ange Serena Ntsopgo" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project, idx) => (
            <a 
              key={idx} 
              href={project.link}
              className={`border border-zinc-900 bg-zinc-950/10 hover:bg-zinc-900/20 backdrop-blur-sm rounded-2xl flex flex-col justify-between group transition-all duration-300 hover:border-zinc-800/80 overflow-hidden ${
                idx === 6 ? 'md:col-span-2' : ''
              }`}
            >
              <div className="w-full h-48 sm:h-64 overflow-hidden border-b border-zinc-900/80 relative">
                <img 
                  src={project.image} 
                  alt={project.title} 
